"""File utilities untuk sistem evaluasi perwadag."""
...
class EvaluasiFileManager:
    """Utility class untuk manage file evaluasi."""
    ...
    # =========================
    # MULTIPLE FILES HANDLER (untuk meetings)
    # =========================
    ...
    async def add_meeting_file(
        ...
        """Add single file to existing meeting files."""
        self._validate_file(file, FileType.MEETING_BUKTI)
